...
def create_4by4_images(res, nome_immagine,lichene_type):
    ...
    cv2.imwrite("grid_classification/descriptors/img/" + nome_immagine +".jpg",cv2.cvtColor(image.astype(np.uint8), cv2.COLOR_RGB2BGR))
...
c =('grid_classification/descriptors/labels/text_image_N2.npy')
